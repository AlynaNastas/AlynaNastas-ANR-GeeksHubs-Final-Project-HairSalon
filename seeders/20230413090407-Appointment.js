...
module.exports = {
  async up (queryInterface, Sequelize) {
    ...
    [
      ...
      {id: 2, stylist_id: 2, client_id: 5, service_id: 2, date: new Date(), comments:"Wella colour allergy. Use natural colour on this client.", createdAt: new Date(), updatedAt: new Date(),},
      ...
      {id: 4, stylist_id: 1, client_id: 4, service_id: 16, date: new Date(), comments:"jajaja",  createdAt: new Date(), updatedAt: new Date(),},
      ...
      {id: 7, stylist_id: 1, client_id: 4, service_id: 3, date: new Date(), comments:"Always cuts with the Manager",  createdAt: new Date(), updatedAt: new Date(),},
      {id: 8, stylist_id: 2, client_id: 5, service_id: 20, date: new Date(), comments:"Discount next time", createdAt: new Date(), updatedAt: new Date(),},
      {id: 9, stylist_id: 2, client_id: 5, service_id: 14, date: new Date(), comments:"Always does boost treatment", createdAt: new Date(), updatedAt: new Date(),},
